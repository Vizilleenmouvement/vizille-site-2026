...
.ph{padding:.72rem 1.4rem;background:#fff;border-bottom:1px solid var(--w2);display:flex;align-items:center;gap:12px;flex-shrink:0;position:sticky;top:0;z-index:5;box-shadow:var(--s1);}
...
.scr{flex:1;overflow-y:auto;min-height:0;padding:1.2rem 1.4rem;}
.scr::-webkit-scrollbar{width:4px;}.scr::-webkit-scrollbar-thumb{background:var(--w3);border-radius:2px;}

/* PAGES */
.page{display:none;}.page.on{display:flex!important;flex-direction:column;flex:1;min-height:0;overflow:hidden;}@keyframes fadeIn{from{opacity:0}to{opacity:1}}
